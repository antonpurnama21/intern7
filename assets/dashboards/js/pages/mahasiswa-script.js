...
$(function() {
    ...
    $.ajax({
        type:'POST',
        url: $('#getResidence').val(),
        dataType:"JSON",
        success: function(data) {
            $('#Residenceid').select2({
                placeholder: 'Pick Residence',
                data: data
            });
        }
    });
    ...
    $("#dokumen-form").validate({
        ...
        messages: {
            ...
            Photofile: {
                extensionImage: "Alowed type {jpeg,jpg,png}",
                filesize: "Maximum size 1024KB"
            },
            Cvfile: {
                extensionImage: "Alowed type {pdf}",
                filesize: "Maximum size 512KB"
            },
            Acfile: {
                extensionImage: "Alowed type {pdf}",
                filesize: "Maximum size 512KB"
