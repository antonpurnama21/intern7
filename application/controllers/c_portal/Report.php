...
class Report extends CI_Controller {
	...
	{
		parent::__construct();
		if ($this->session->userdata('login')['is_login'] == FALSE) :
	...
	public function reportMahasiswa()
	{
		$data = array(
				...
				'dtdosen' => $this->Mod_crud->getData('result', 'm.*,ff.*,l.roleID', 't_mahasiswa m', null, null, array('t_mahasiswa_file ff'=>'m.mahasiswaID = ff.mahasiswaID','t_login l'=>'m.loginID = l.loginID'), null, null, array('m.mahasiswaID ASC'))
			);
