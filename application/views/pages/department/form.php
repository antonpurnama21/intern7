			...
			<form class="form-horizontal form-validate-jquery" action="<?= $formAction ?>" method="post" enctype="multipart/form-data" name="dokumen-form" id="dokumen-form">
				<div class="modal-body">
					<fieldset class="content-group">
						...
						<input type="hidden" name="Deptid" id="Deptid" class="form-control" placeholder="Admin ID" title="Admin ID" value="<?= isset($dMaster->deptID) ? $dMaster->deptID : '' ?>" readonly>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div class="input-group">
										...
										<input type="text" name="Deptname" id="Deptname" class="form-control" required="required" placeholder="Insert Department" title="Insert Department" value="<?= isset($dMaster->deptName) ? $dMaster->deptName : '' ?>" required>
									</div>
								</div>
							</div>
						</div>
