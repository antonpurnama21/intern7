							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<div class="input-group">
										...
										<input type="text" name="Birthdate" id="Birthdate" class="form-control pickadate" required="required" placeholder="Pick date" title="Pick date" value="<?= isset($dMaster->birthDate) ? $dMaster->birthDate : '' ?>">
									</div>
								</div>
							</div>
						</div>
