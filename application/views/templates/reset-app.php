...
<!-- Mirrored from pipeline.mediumra.re/utility-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Nov 2019 02:26:50 GMT -->
...
<head>
    ...
    <link href="<?=base_url()?>assets/app/assets/img/favicon.ico" rel="icon" type="image/x-icon">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Gothic+A1" rel="stylesheet">
    <link href="<?=base_url()?>assets/app/assets/css/theme.css" rel="stylesheet" type="text/css" media="all" />
  </head>
  ...
  <body>
            ...
            <div class="text-center">
              ...
              <form>
                <div class="form-group">
                  <input class="form-control" type="email" placeholder="Email Address" name="forgot-password-email" />
                </div>
    ...
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/popper.min.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/bootstrap.js"></script>

    <!-- Optional Vendor Scripts (Remove the plugin script here and comment initializer script out of index.js if site does not use that feature) -->

    <!-- Autosize - resizes textarea inputs as user types -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/autosize.min.js"></script>
    <!-- Flatpickr (calendar/date/time picker UI) -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/flatpickr.min.js"></script>
    <!-- Prism - displays formatted code boxes -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/prism.js"></script>
    <!-- Shopify Draggable - drag, drop and sort items on page -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/draggable.bundle.legacy.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/swap-animation.js"></script>
    <!-- Dropzone - drag and drop files onto the page for uploading -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/dropzone.min.js"></script>
    <!-- List.js - filter list elements -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/list.min.js"></script>

    <!-- Required theme scripts (Do not remove) -->
    <script type="text/javascript" src="<?=base_url()?>assets/app/assets/js/theme.js"></script>
