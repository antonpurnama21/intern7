<div class="sidebar-category sidebar-category-visible">
	<div class="category-content no-padding">
		<ul class="navigation navigation-main navigation-accordion">
			...
			<li <?= getActiveFunc('scope/index') ?>><a href="<?= base_url('scope') ?>"><i class="icon-bookmark"></i> <span>Project Scope List</span></a></li>
			...
			<li style="<?= showLevel(array(11,22)); ?>" <?= getActiveFunc('scope/manage') ?>><a href="<?= base_url('scope/manage') ?>"><i class="icon-calendar"></i> <span>Manage Project Scope</span></a></li>
