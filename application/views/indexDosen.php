<div class="panel panel-flat">
	...
	<div class="panel-body">
		<h5>Selamat Datang <?= $sesi['sess_name']?> !</h5>
	</div>
</div>
...
<div class="row">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="form-group">
						<label class="control-label col-lg-8 text-bold ">Total </label>
						<div class="col-lg-4">
	...
	<div class="col-md-3">
		<div class="panel panel-white border-top-success">
			<div class="panel-heading">
				<h6 class="panel-title text-bold"><i class="icon-puzzle3"></i> Dosen Total</h6>
			</div>
